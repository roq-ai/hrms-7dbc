            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  ...
                  text={format(parseISO(data?.onboarding_date as unknown as string), 'dd-MM-yyyy')}
                />

                <FormListItem
                  label="Exit Date"
                  text={format(parseISO(data?.exit_date as unknown as string), 'dd-MM-yyyy')}
                />

                <FormListItem label="Leave Days" text={data?.leave_days} />

                <FormListItem label="Attendance Days" text={data?.attendance_days} />
