  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        format(parseISO(record?.onboarding_date as unknown as string), 'dd-MM-yyyy'),
    },
    {
      id: 'exit_date',
      header: 'Exit Date',
      ...
      cell: ({ row: { original: record } }: any) =>
        format(parseISO(record?.exit_date as unknown as string), 'dd-MM-yyyy'),
    },
    { id: 'leave_days', header: 'leave_days', accessorKey: 'leave_days' },
    { id: 'attendance_days', header: 'attendance_days', accessorKey: 'attendance_days' },
